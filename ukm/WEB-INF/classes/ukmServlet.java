   ...
   public  class ukmServlet extends HttpServlet {
     //Use a prepared statement to store a student into the database
     Connection conn = null;
	 PreparedStatement pstmt1, pstmt2, pstmt3, pstmt4, pstmt5, pstmt6, pstmt7 = null;
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
     ...
     try {
      ...
      String alumni = request.getParameter("alumni");
			...
			out.println("<h2 align=\"center\"><img src=\"ukm.png\" /><p><p></p><br /><font size=\"5\">Confession of the Data Given</font><br /><br /></h2>");
			out.println("<font size=\"5\">Personal Detail</font><hr /><br />");
			out.println("<form method = \"post\" action = \"/ukm/ukmServlet2\">");
			...
			out.println("<h2 align=\"center\"><font size=\"5\">Confession</font><br /></h2>");
			out.println("<h2 align=\"center\"><font size=\"3\">I, " + studentName + " declare that all");
			out.print(" information provided is true, and I am also willing to accept the responsibilities and the");
			out.print(" trust placed in them with sincerity and excellence.</font><br><br /></h2>");


			out.print("<p align=\"center\"><input type = \"submit\" name = \"Submit\" value = \"Ok\">");
            out.print("<INPUT TYPE=\"button\" VALUE=\"Back\" onClick=\"history.go(-1);return true;\">");
            out.print("</p>");
			...
			try {
		       if (studentName.length() == 0 || matric.length() == 0) {
		         out.println("Please Complete The form");
		         return; // method to check the blank field
		       	}




		      pstmt1 = conn.prepareStatement("INSERT INTO PerDetail ( matric, studentName, ic, religion, race, room, phone, lastIns, programme, email, street, city, state, zip) " +
						"VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");

		      pstmt1.setString(1, matric);
		      pstmt1.setString(2, studentName);
		      pstmt1.setString(3, ic);
		      pstmt1.setString(4, religion);
		      pstmt1.setString(5, race);
		      pstmt1.setString(6, room);
		      pstmt1.setString(7, phone);
		      pstmt1.setString(8, lastIns);
		      pstmt1.setString(9, programme);
		      pstmt1.setString(10, email);
		      pstmt1.setString(11, street);
		      pstmt1.setString(12, city);
		      pstmt1.setString(13, state);
		      pstmt1.setString(14, zip);
		      pstmt1.executeUpdate();


            	pstmt2 = conn.prepareStatement("INSERT INTO curricular (matric, association, year1, position, activities, year2, involvement, awards, year3) " +
						"VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");

			  pstmt2.setString(1, matric);
		      pstmt2.setString(2, cclub1);
		      pstmt2.setString(3, cyear1);
		      pstmt2.setString(4, cposition1);
		      pstmt2.setString(5, ac1);
		      pstmt2.setString(6, acyear1);
		      pstmt2.setString(7, invol1);
		      pstmt2.setString(8, awa1);
		      pstmt2.setString(9, awayear1);
		      pstmt2.executeUpdate();

		      	pstmt3 = conn.prepareStatement("INSERT INTO curricular (matric, association, year1, position, activities, year2, involvement, awards, year3) " +
						"VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");

			  pstmt3.setString(1, matric);
		      pstmt3.setString(2, cclub2);
		      pstmt3.setString(3, cyear2);
		      pstmt3.setString(4, cposition2);
		      pstmt3.setString(5, ac2);
		      pstmt3.setString(6, acyear2);
		      pstmt3.setString(7, invol2);
		      pstmt3.setString(8, awa2);
		      pstmt3.setString(9, awayear2);
		      pstmt3.executeUpdate();

		      	pstmt4 = conn.prepareStatement("INSERT INTO curricular (matric, association, year1, position, activities, year2, involvement) " +
						"VALUES (?, ?, ?, ?, ?, ?, ?)");

			  pstmt4.setString(1, matric);
		      pstmt4.setString(2, cclub3);
		      pstmt4.setString(3, cyear3);
		      pstmt4.setString(4, cposition3);
		      pstmt4.setString(5, ac3);
		      pstmt4.setString(6, acyear3);
		      pstmt4.setString(7, invol3);
		      pstmt4.executeUpdate();

		      	pstmt5 = conn.prepareStatement("INSERT INTO curricular (matric, association, year1, position, activities, year2, involvement) " +
						"VALUES (?, ?, ?, ?, ?, ?, ?)");

			  pstmt5.setString(1, matric);
		      pstmt5.setString(2, cclub4);
		      pstmt5.setString(3, cyear4);
		      pstmt5.setString(4, cposition4);
		      pstmt5.setString(5, ac4);
		      pstmt5.setString(6, acyear4);
		      pstmt5.setString(7, invol4);
		      pstmt5.executeUpdate();

		      	pstmt6 = conn.prepareStatement("INSERT INTO curricular (matric, association, year1, position, activities, year2, involvement) " +
						"VALUES (?, ?, ?, ?, ?, ?, ?)");

			  pstmt6.setString(1, matric);
		      pstmt6.setString(2, cclub5);
		      pstmt6.setString(3, cyear5);
		      pstmt6.setString(4, cposition5);
		      pstmt6.setString(5, ac5);
		      pstmt6.setString(6, acyear5);
		      pstmt6.setString(7, invol5);
		      pstmt6.executeUpdate();

		      	pstmt7 = conn.prepareStatement("INSERT INTO skill (matric, office, photoshop, illustrator, flash, video, others, othersField) " +
						"VALUES (?, ?, ?, ?, ?, ?, ?, ?)");

			  pstmt7.setString(1, matric);
		      pstmt7.setString(2, cclub5);
		      pstmt7.setString(3, cyear5);
		      pstmt7.setString(4, cposition5);
		      pstmt7.setString(5, ac5);
		      pstmt7.setString(6, acyear5);
		      pstmt7.setString(7, invol5);
		      pstmt7.setString(7, explainSkill);
